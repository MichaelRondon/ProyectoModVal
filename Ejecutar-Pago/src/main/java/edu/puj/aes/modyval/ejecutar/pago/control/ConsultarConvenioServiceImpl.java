...
import edu.puj.aes.modyval.ejecutar.pago.remote.artifacts.consulta.wsdl.ConsultarPagoInterface;
...
public class ConsultarConvenioServiceImpl implements ConsultarConvenioService {
    ...
    public ConsultarFacturaResp consultar(ConsultarFacturaReq consultarFacturaReq) {
        try {
            edu.puj.aes.modyval.ejecutar.pago.remote.artifacts.consulta.wsdl.ConsultarConvenioService consultarConvenioService
                    = new edu.puj.aes.modyval.ejecutar.pago.remote.artifacts.consulta.wsdl.ConsultarConvenioService(new URL(ConsultarConvenioService.WSDL_URI));
