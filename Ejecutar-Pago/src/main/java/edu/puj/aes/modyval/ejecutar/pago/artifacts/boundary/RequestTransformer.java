...
public class RequestTransformer {
    ...
    public edu.puj.aes.modyval.ejecutar.pago.artifacts.dispatcher.wsdl.EjecutarPagoReq getPagoReq() {
    ...
    public edu.puj.aes.modyval.ejecutar.pago.artifacts.saldos.wsdl.ConsultarCuentaReq getConsultarCuentaReq() {
        edu.puj.aes.modyval.ejecutar.pago.artifacts.saldos.wsdl.ConsultarCuentaReq consultarCuentaReq = new edu.puj.aes.modyval.ejecutar.pago.artifacts.saldos.wsdl.ConsultarCuentaReq();
    ...
    public edu.puj.aes.modyval.ejecutar.pago.artifacts.saldos.wsdl.ModificarCuentaReq getModificarCuentaReq(boolean compensacion) {
        edu.puj.aes.modyval.ejecutar.pago.artifacts.saldos.wsdl.ModificarCuentaReq modificarCuentaReq = new edu.puj.aes.modyval.ejecutar.pago.artifacts.saldos.wsdl.ModificarCuentaReq();
