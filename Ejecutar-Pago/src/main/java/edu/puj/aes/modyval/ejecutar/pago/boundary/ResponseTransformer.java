...
public class ResponseTransformer {
    ...
    public ResponseTransformer(edu.puj.aes.modyval.ejecutar.pago.remote.artifacts.consulta.wsdl.ConsultarFacturaResp consultarFacturaResp) {
    ...
    public ResponseTransformer(edu.puj.aes.modyval.ejecutar.pago.remote.artifacts.dispatcher.wsdl.ConsultarFacturaResp consultarFacturaResp) {
        ConsultarFacturaResp consultarFacturaResp1 = new ConsultarFacturaResp();
        consultarFacturaResp1.setIdFactura(consultarFacturaResp.getIdFactura());
        consultarFacturaResp1.setMensajeError(consultarFacturaResp.getMensajeError());
        consultarFacturaResp1.setValorFactura(consultarFacturaResp.getValorFactura());
    ...
    public ResponseTransformer(edu.puj.aes.modyval.ejecutar.pago.remote.artifacts.saldos.wsdl.ConsultarCuentasResp consultarCuentasResp,
